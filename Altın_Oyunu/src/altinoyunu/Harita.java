...
public class Harita extends JLabel {
    ...
    public void SiraKimde() {
        ...
        } else if (mSiraKimde % 4 == 2) {
            if (C.mOynuyor) {
                Hareket(C, cAdres);
            }
        } else if (mSiraKimde % 4 == 1) {
            if (B.mOynuyor) {
                Hareket(B, bAdres);
            }
        } else if (mSiraKimde % 4 == 0) {
            if (A.mOynuyor) {
                Hareket(A, aAdres);
            }
        }
...
//                System.out.println("    D alındı " + Altin.get(adres).getX() + "  " + Altin.get(adres).getX());
        ...
        for (int i = 0; i < adim; i++) {
            ...
            if (H.mPuan <= 0) {
                H.mOynuyor = false;
                JOptionPane.showMessageDialog(labelFor, H.mKarakter + " karakterinin altını bitti!\nAltın: " + H.mPuan);
                mBittiKontrol--;
                if (mBittiKontrol == 1) {
                    JOptionPane.showMessageDialog(labelFor, "Oyun bitti"
                            + "\nA'nin Altin Sayisi = " + A.mPuan + "\nB'nin Altin Sayisi = " + B.mPuan + "\nC'nin Altin Sayisi = "
                            + +C.mPuan + "\nD'nin Altin Sayisi = " + D.mPuan + ""
                            + "\nA'nin Adim Sayisi = " + A.mToplamAdimSayisi + "\nB'nin Adim Sayisi = " + B.mToplamAdimSayisi + ""
                            + "\nC'nin Adim Sayisi = " + C.mToplamAdimSayisi + "\nD'nin Adim Sayisi = " + D.mToplamAdimSayisi + ""
                            + "\nA'nin Harcadigi Altin = " + A.mToplamHarcananAltin + "\nB'nin Harcadigi Altin = " + B.mToplamHarcananAltin + ""
                            + "\nC'nin Harcadigi Altin = " + C.mToplamHarcananAltin + "\nD'nin Harcadigi Altin = " + D.mToplamHarcananAltin
                            + "\nA'nin Topladigi Altin = " + A.mToplananAltin + "\nB'nin Topladigi Altin = " + B.mToplananAltin + ""
                            + "\nC'nin Topladigi Altin = " + C.mToplananAltin + "\nD'nin Topladigi Altin = " + D.mToplananAltin);
                    mTimer.stop();
                }
                return;
            }
            ...
            {
                if (Altin.get(s).mMevcut && !Altin.get(s).mGizliMi){
                    if (H.getY() == Altin.get(s).getY() && H.getX() == Altin.get(s).getX()) {
