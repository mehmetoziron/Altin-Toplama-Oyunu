...
public class Ayarlar extends javax.swing.JFrame {
    ...
    public Ayarlar() {
        ...
        setBounds((Dim.width-439)/2,(Dim.height-300)/2,439,320);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Genişlik ve yüksekliği giriniz (MAX 63-33)");

        jLabel2.setText("%");

        jLabel3.setText("%");

        jLabel4.setText("Altın yüzdesni seçiniz");

        jLabel5.setText("Hamle sayısını seçiniz");

        jLabel6.setText("Gizli altın yüzdesini seçiniz");

        jLabel7.setText("Oyuncuların başlangıç altınlarını seçiniz");
    ...
    private void BaslatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BaslatActionPerformed
        ...
        int sizeX,sizeY,mMaxEn,mMaxBoy;
